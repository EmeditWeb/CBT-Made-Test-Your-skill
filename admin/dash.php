...
<div class="col-md-12">
  <!--Default Page-->
  <?php if(@$_GET['q']==0.5) {
    echo '<div class="panel"><center><h1 class="title" style="color:#660033">Welcome to Admin Portal!!</h1><center><br /></div>';
    }?>
    <!--Default Page Ends-->
<!--home start-->
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter Quiz title" class="form-control input-md" type="text" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Enter total number of questions" class="form-control input-md" type="number" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter marks on right answer" class="form-control input-md" min="0" type="number" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Enter minus marks on wrong answer without sign" class="form-control input-md" min="0" type="number" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="Enter time limit for test in minute" class="form-control input-md" min="1" type="number" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="Enter #tag which is used for searching" class="form-control input-md" type="text" required="required">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" required="required" placeholder="Write description here..."></textarea>  
  </div>
</div>
...
<!-- You won't believe it's A Microbiology That built this from the scrach,,, There's no limits to what you can do,,Start Now -->